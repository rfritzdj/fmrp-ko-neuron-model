...
All kinetics are fixed (parameters Aah, Sah, etc. are not fit). They were already fit by hand due to the complexity of the model. The model simulation at dt = 0.02 ms takes ~25 ms after JIT warm-up.
